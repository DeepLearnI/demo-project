...
try:
    ...
    try:
        ...
        from utils import get_params, save_preprocessors, load_preprocessors, post_slack_channel
    except Exception:
        from src.preprocessing import download_data, preprocess_data
        from src.model import Model
        from src.utils import get_params, save_preprocessors, load_preprocessors, post_slack_channel    

...
def init_configuration(config_file="./config/config.yaml"):
    ...
    parser.add('--recurrency_type', default='TCN')
    parser.add('--tcn_units', action='append', default=[], type=int)
    parser.add('--kernel_sizes', action='append', default=[], type=int)
    parser.add('--dilations', action='append', default=[], type=int)
    parser.add('--tcn_dropout', action='append', default=[], type=float)
    parser.add('--spatial_dropout', action='store_true')
